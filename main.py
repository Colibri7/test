...
def log_uz(message):
    def password_uz(message):
        ...
        if checkUsername["password_hash"] == out:
            ...
            bot.send_message(message.chat.id, "Noto'g'ri parol yoki pochta")
    ...
    if message.text in list:
        ...
        lg1 = types.InlineKeyboardButton("Ro'yxatdan o'tish", callback_data='register',
                                         url='https://hostmaster.uz/site/signup/')
        key.add(lg1)
        bot.send_message(message.chat.id, "Siz ro'yxatdan o'tishingiz kerak", reply_markup=key)
...
def log(message):
    def password(message):
        ...
        if checkUsername["password_hash"] == out:
            ...
            bot.send_message(message.chat.id, 'Неверный пароль или почта')
    ...
    if message.text in list:
        ...
        lg1 = types.InlineKeyboardButton('Зарегистрировать', callback_data='register',
                                         url='https://hostmaster.uz/site/signup/')
        key.add(lg1)
